 ...
 */
public class Ejercicio5h {

   {
     
    
    Ejercicio5h objeto12 = new Ejercicio5h();  
    Ejercicio5h objeto13 = new Ejercicio5h();
    Ejercicio5h objeto14 = new Ejercicio5h();
    Ejercicio5h objeto15 = new Ejercicio5h();
    ...
    try {
      ...
      public static String[] obtenerRegistroPorColumna(int columna, Object lenguajes [][]) throws Exception {
                Scanner leer = new Scanner(System.in);
                System.out.println("Ingrese la fila a evaluar y buscar valores ");
                columna = leer.nextInt();
            try {
                return (String[]) lenguajes[columna];
            } catch (IndexOutOfBoundsException e) {
                throw new Exception("La columna no existe en la matriz de lenguajes");
            }
    }    
}
